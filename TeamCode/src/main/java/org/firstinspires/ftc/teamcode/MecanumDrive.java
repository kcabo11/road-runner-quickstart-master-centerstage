...
public final class MecanumDrive {
    ...
    public static class Params {
        ...
        public double inPerTick = -0.0402; //.04146315; //2303.25 ticks, 95.5 inches
        //1553.75 //1551
        public double lateralInPerTick = -0.01814;//-0.01374; // -0.0085;// -0.04252806 <-- 1/23 //.04144965; //2304.0 ticks, 95.5 in
        public double trackWidthTicks = -718.6276394944668; //-701.116790143736;


        // feedforward parameters (in tick units)
        public double kS = 1.71388; //1.7826444; //1.70373576;
        public double kV = -0.00435151;//0.00878811;
        public double kA = 0.001; // kA = ACCELERATION, so don't put it to 1000... like last time
        // Roadrunner testing:
        //0.0001 - decent
        ...
        // Roadrunner Testing:
        // - decent
        public double lateralGain = 0.0; // side-to-side
        public double headingGain = 7.0; // heading // shared with turn
